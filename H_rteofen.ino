...
int thermoDO = 11;    //do pin for thermocouple
int thermoCS = 12;    //cs pin for thermocouple
int thermoCLK = 13;   //clk pin for thermocouple
...
if (thermocouple.readCelsius() < targetTemp && cyclestart == 1){
